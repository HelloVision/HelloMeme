...
"""
@File   : models6/hm_denoising_3d.py
@Author : Songkey
@Email  : songkey@pku.edu.cn
@Date   : 8/14/2024
@Desc   : 删除实验代码，精简结构
adapted from: https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/unets/unet_2d_condition.py
"""
...
class HMDenoising3D(UNet2DConditionModel, CopyWeights, InsertReferenceAdapter):
    def forward(
        ...
        if not added_cond_kwargs is None and 'image_embeds' in added_cond_kwargs:
